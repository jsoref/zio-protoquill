...
class InsertLiftedSpec extends Spec {
  ...
  "Lifted Insert should work for" - {
    "Persian/Name/First/value:String`" in {
    ...
    "Persian/Option[Name]/First/value:Option[String]`" in {
    ...
    "Persian/Option[Name]/First/value:String`" in {
      case class First(value: String)
      case class Name(first: First, last: String)
      case class Person(name: Option[Name], age: Int)
    ...
    "Persian/Option[Name]/First/Value/value:Option[String]`" in {
